...
var shockwave = function shockwave(props) {
  return (0, _styledComponents.keyframes)(_templateObject, function (props) {
    return props.secondaryColor;
  }, (0, _polished.darken)(0.2, props.secondaryColor), props.secondaryColor);
};

var ClapButton = _styledComponents2.default.button(_templateObject2, function (props) {
...
var ClapCount = _styledComponents2.default.span(_templateObject3, function (props) {
...
var ClapCountTotal = _styledComponents2.default.span(_templateObject4, function (props) {
  return props.size;
}, function (props) {
  return props.size / 3.5;
}, function (props) {
  return props.primaryColor;
});
