...
var _ClapWrap = require('./components/ClapWrap')

var _ClapWrap2 = _interopRequireDefault(_ClapWrap)

var _ClapIcon = require('./components/ClapIcon')

var _ClapIcon2 = _interopRequireDefault(_ClapIcon)
...
var Clap = (function (_React$Component) {
  ...
  function Clap (props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (Clap.__proto__ || Object.getPrototypeOf(Clap)).call(this, props)
    )
  ...
  _createClass(Clap, [
    {
      ...
      value: function componentDidMount () {
        ...
        var opacityStart = this.props.count > 0 && this.state.unclicked ? 1 : 0

        var countTotalAnimation = new _moJs2.default.Html({
          el: '#clap--count-total',
          isShowStart: false,
          isShowEnd: true,
          opacity: _defineProperty({}, opacityStart, 1),
...
Clap.defaultProps = {
  ...
  maxCount: 50,
  isClicked: false,
  iconComponent: _ClapIcon2.default
}
